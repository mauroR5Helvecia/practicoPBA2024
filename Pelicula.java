...
public class Pelicula extends Video {
    ...
    public Pelicula(String titulo, Integer anio, String genero, Integer duracion, boolean visto, Integer tiempoVisto, Integer calificacion) {
    ...
    public void ponerCalificacion(Integer calificacion) {
        if (calificacion <= 10 && calificacion > 0) {
            ...
            System.out.println("La calificacion de " + getTitulo() + " a sido actualizada a " + calificacion + " puntos");
        } else {
            System.out.println("Ingrese un puntaje con un valor de entre 1 y 10");
        }
    }
}
